...
export default function SliderPadrao({ cursos }) {
    ...
    return (
        <>
                    ...
                    <div key={curso.id}>
                        ...
                        >
                            ...
                            {!verifica(curso?.attributes?.products.data) ? (
                                <Lock size={72} color="#f26321" weight="bold" className="absolute lock-icon cursor-pointer" />
                            ) : (<></>)}
                        </div>
                    </div>
            ...
            <div
                id="modal-course"
                className={`fixed lg:p-10 top-0 left-0 bottom-0  right-0 justify-center w-full h-full flex items-end md:items-center md:justify-center ${modalOpen ? "fadeInModal" : "fadeOutModal"
