                ...
                <div className="w-full flex items-center justify-center">
                    ...
                    <div className="w-full md:w-[400px] h-screen flex flex-col justify-center items-center">
                        ...
                        <form className='w-full mb-8 mt-8 lg:mb-16'>
                            ...
                            <input type="email" name="mail" placeholder='email@email.com' className='w-full border border-[#C1C1C1] px-4 py-3 rounded-lg mt-2 mb-5' value={enterMail} onChange={e => setEnterMail(e.target.value)} required></input>

                            <div className='flex flex-row justify-end -mb-6'>
                                <a href="#" className='text-purple-is underline'>Esqueceu sua senha?</a>
                            </div>

                            <label htmlFor="password" className='block font-bold text-blue-is'>
                                Senha
                            </label>
                            ...
                            <button type='submit' className='block text-center text-lg w-full px-6 py-4 bg-orange-is rounded-lg text-white font-bold hover:bg-orange-hv-is transition-colors'>
                                Entrar
                            </button>
                        </form>
